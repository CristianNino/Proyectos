...
class resultado : AppCompatActivity() {
    ...
    fun SubirPuntuacion(idN: String, id: String, valorR1: Int, valorR2: Int, valorR3: Double,
                        valorR4: Double, valorR5: Double, valorR6: Int){
        database = FirebaseDatabase.getInstance().getReference("Puntuacion")

        val puntuacionP =
            Puntuaciones(idN, id, valorR1.toString(), valorR2.toString(), valorR3.toString(),
                valorR4.toString(), valorR5.toString(), valorR6.toString())
    ...
    fun SubirResultado(idN: String, id: String, puntua1: String, puntua2: String, puntua3: String,
                       puntua4: String, puntua5: String, puntua6: String){
    ...
    fun CalcularPuntuacion( ages:Int, gene: String, valorR1: Int, valorR2: Int, valorR3: Double,
                            valorR4: Double, valorR5: Double, valorR6: Int){
